...
export function BecomeVendor() {
  ...
  const benefits = [
    ...
    { icon: Globe, title: t('becomeVendor.benefit3Title'), desc: t('becomeVendor.benefit3Desc') },
    { icon: Zap, title: t('becomeVendor.benefit4Title'), desc: t('becomeVendor.benefit4Desc') },
    { icon: GShipping, title: t('becomeVendor.benefit5Title'), desc: t('becomeVendor.benefit5Desc') },
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-primary text-white rounded-2xl p-8 shadow-2xl shadow-primary/30 relative">
              ...
              {/* IL PREZZO NON COMPARE NELL'APP NATIVA.
                  Questa pagina è raggiungibile dall'app clienti, e "€199
                  all'anno" è un richiamo all'acquisto esterno: è
                  esattamente ciò che la regola 3.1.3 vieta, e che ha fatto
                  cadere l'esenzione a uno sviluppatore per una sola frase
                  sulla schermata di accesso. Sul web resta visibile — lì
                  serve, ed è dove i venditori si iscrivono davvero. */}
              {superficieCommercialeVisibile() && (
