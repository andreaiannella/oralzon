    ...
    <div className="min-h-screen bg-muted">
      ...
      <div className="bg-white border-b border-border py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl mb-2">Catalogo Prodotti</h1>
          <p className="text-muted-foreground">
            {loading ? 'Caricamento...' : `${filtered.length} prodotti disponibili`}
          </p>
        </div>
      </div>
          ...
          <aside className="w-64 flex-shrink-0 hidden lg:block">
            <div className="bg-white rounded-xl border border-border p-6 sticky top-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-semibold">Filtra per Categoria</h2>
              </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            {!loading && filtered.length === 0 && (
              <div className="bg-white rounded-xl border border-border p-12 text-center">
                ...
                <p className="text-lg font-medium text-gray-900 mb-2">Nessun prodotto trovato</p>
                <p className="text-gray-500 text-sm">
                  {products.length === 0
                    ? 'Non ci sono ancora prodotti in questa categoria. I vendor stanno caricando il catalogo.'
                  ...
                  >
                    ...
                    <div className="p-5 flex-1">
                      <div className="flex items-center gap-1 mb-1">
                        <span className="text-xs text-muted-foreground">{product.vendors?.business_name || 'Venditore'}</span>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="flex items-center gap-1 text-xs text-muted-foreground">
                          <ShoppingCart className="w-3 h-3" /> Aggiungi
                        </span>
                      </div>
                    </div>
                  </Link>
