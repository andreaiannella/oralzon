...
const L: Record<InvoiceLang, InvoiceLabels> = {
  it: {
    docTitle: 'Fattura', paid: 'Pagato', paymentRef: 'Numero di riferimento del pagamento',
    soldBy: 'Venduto da', vatNo: 'P. IVA', invoiceDate: 'Data di fatturazione',
    invoiceNumber: 'Numero fattura', totalDue: 'Totale da pagare',
    ...
    exclVat: 'IVA esclusa', inclVat: 'IVA inclusa', invoiceTotal: 'Totale fattura',
    ...
    marketplaceNote: 'Questo documento è stato generato da Oralzon in qualità di piattaforma marketplace attraverso cui la vendita è stata effettuata e il pagamento processato per conto del venditore. Oralzon non è il venditore di questi prodotti: la responsabilità fiscale e commerciale della vendita è di {v}.',
    footerTagline: 'Marketplace B2B odontoiatrico', generatedOn: 'Documento generato automaticamente il',
    buttonLabel: 'Fattura PDF',
  },
  en: {
    docTitle: 'Invoice', paid: 'Paid', paymentRef: 'Payment reference number',
    soldBy: 'Sold by', vatNo: 'VAT no.', invoiceDate: 'Invoice date',
    invoiceNumber: 'Invoice number', totalDue: 'Total due',
    ...
    exclVat: 'excl. VAT', inclVat: 'incl. VAT', invoiceTotal: 'Invoice total',
    ...
    marketplaceNote: 'This document was generated by Oralzon as the marketplace platform through which the sale was made and the payment processed on behalf of the seller. Oralzon is not the seller of these goods: fiscal and commercial responsibility for the sale lies with {v}.',
    footerTagline: 'B2B dental marketplace', generatedOn: 'Document generated automatically on',
    buttonLabel: 'Invoice PDF',
  },
  de: {
    docTitle: 'Rechnung', paid: 'Bezahlt', paymentRef: 'Zahlungsreferenznummer',
    soldBy: 'Verkauft von', vatNo: 'USt-IdNr.', invoiceDate: 'Rechnungsdatum',
    invoiceNumber: 'Rechnungsnummer', totalDue: 'Gesamtbetrag',
    ...
    exclVat: 'zzgl. USt', inclVat: 'inkl. USt', invoiceTotal: 'Rechnungsbetrag',
    ...
    marketplaceNote: 'Dieses Dokument wurde von Oralzon als Marktplatzbetreiber erstellt, über den der Verkauf erfolgte und die Zahlung im Namen des Verkäufers abgewickelt wurde. Oralzon ist nicht der Verkäufer dieser Waren: die steuerliche und handelsrechtliche Verantwortung liegt bei {v}.',
    footerTagline: 'B2B-Marktplatz für Dentalbedarf', generatedOn: 'Dokument automatisch erstellt am',
    buttonLabel: 'Rechnung als PDF',
  },
  fr: {
    docTitle: 'Facture', paid: 'Payé', paymentRef: 'Numéro de référence du paiement',
    soldBy: 'Vendu par', vatNo: 'N° TVA', invoiceDate: 'Date de facturation',
    invoiceNumber: 'Numéro de facture', totalDue: 'Montant total',
    ...
    exclVat: 'HT', inclVat: 'TTC', invoiceTotal: 'Total facture',
    ...
    marketplaceNote: "Ce document a été généré par Oralzon en tant que plateforme de marketplace par laquelle la vente a été réalisée et le paiement traité pour le compte du vendeur. Oralzon n'est pas le vendeur de ces produits : la responsabilité fiscale et commerciale incombe à {v}.",
    footerTagline: 'Marketplace B2B dentaire', generatedOn: 'Document généré automatiquement le',
    buttonLabel: 'Facture PDF',
  },
  es: {
    docTitle: 'Factura', paid: 'Pagado', paymentRef: 'Número de referencia del pago',
    soldBy: 'Vendido por', vatNo: 'NIF/IVA', invoiceDate: 'Fecha de factura',
    invoiceNumber: 'Número de factura', totalDue: 'Total a pagar',
    ...
    exclVat: 'sin IVA', inclVat: 'IVA incluido', invoiceTotal: 'Total factura',
    ...
    marketplaceNote: 'Este documento ha sido generado por Oralzon como plataforma de marketplace a través de la cual se realizó la venta y se procesó el pago por cuenta del vendedor. Oralzon no es el vendedor de estos productos: la responsabilidad fiscal y comercial corresponde a {v}.',
    footerTagline: 'Marketplace B2B dental', generatedOn: 'Documento generado automáticamente el',
    buttonLabel: 'Factura PDF',
  },
  pt: {
    docTitle: 'Fatura', paid: 'Pago', paymentRef: 'Número de referência do pagamento',
    soldBy: 'Vendido por', vatNo: 'NIF/IVA', invoiceDate: 'Data da fatura',
    invoiceNumber: 'Número da fatura', totalDue: 'Total a pagar',
    ...
    exclVat: 'sem IVA', inclVat: 'com IVA', invoiceTotal: 'Total da fatura',
    ...
    marketplaceNote: 'Este documento foi gerado pela Oralzon enquanto plataforma de marketplace através da qual a venda foi efetuada e o pagamento processado por conta do vendedor. A Oralzon não é a vendedora destes produtos: a responsabilidade fiscal e comercial é de {v}.',
    footerTagline: 'Marketplace B2B dentário', generatedOn: 'Documento gerado automaticamente em',
    buttonLabel: 'Fatura PDF',
  },
  nl: {
    docTitle: 'Factuur', paid: 'Betaald', paymentRef: 'Betalingsreferentie',
    soldBy: 'Verkocht door', vatNo: 'Btw-nummer', invoiceDate: 'Factuurdatum',
    invoiceNumber: 'Factuurnummer', totalDue: 'Totaalbedrag',
    ...
    exclVat: 'excl. btw', inclVat: 'incl. btw', invoiceTotal: 'Factuurtotaal',
    ...
    marketplaceNote: 'Dit document is opgesteld door Oralzon als marktplaatsplatform waarlangs de verkoop heeft plaatsgevonden en de betaling namens de verkoper is verwerkt. Oralzon is niet de verkoper van deze producten: de fiscale en commerciële verantwoordelijkheid ligt bij {v}.',
    footerTagline: 'B2B-marktplaats voor tandheelkundige benodigdheden', generatedOn: 'Document automatisch gegenereerd op',
    buttonLabel: 'Factuur pdf',
  },
  pl: {
    docTitle: 'Faktura', paid: 'Opłacono', paymentRef: 'Numer referencyjny płatności',
    soldBy: 'Sprzedawca', vatNo: 'NIP', invoiceDate: 'Data wystawienia',
    invoiceNumber: 'Numer faktury', totalDue: 'Do zapłaty',
    ...
    exclVat: 'netto', inclVat: 'brutto', invoiceTotal: 'Razem do zapłaty',
    ...
    marketplaceNote: 'Dokument został wygenerowany przez Oralzon jako platformę marketplace, za pośrednictwem której doszło do sprzedaży, a płatność została obsłużona w imieniu sprzedawcy. Oralzon nie jest sprzedawcą tych towarów: odpowiedzialność podatkowa i handlowa spoczywa na {v}.',
    footerTagline: 'Marketplace B2B dla stomatologii', generatedOn: 'Dokument wygenerowany automatycznie dnia',
    buttonLabel: 'Faktura PDF',
  },
};
