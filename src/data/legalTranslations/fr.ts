  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Les résultats de recherche sont classés en combinant la **correspondance avec le terme recherché** et certains paramètres relatifs au produit. La correspondance demeure le facteur dominant : les autres paramètres déterminent l'ordre **entre produits également pertinents**, et non pour placer un produit moins pertinent avant un plus pertinent."
      ],
      bullets: [
        "**Correspondance avec la recherche** — le paramètre prépondérant, qu'aucun autre ne peut renverser. La recherche compare le terme saisi au nom du produit (y compris traduit), à la marque, à la référence et à la description, avec un poids décroissant dans cet ordre : une correspondance dans le nom compte plus que le même mot présent uniquement dans la description",
        "**Filtres et tri choisis par l'acheteur** — lorsque l'acheteur trie par prix, ce choix prévaut sur tout autre paramètre, y compris les placements payants",
        "**Disponibilité** — à correspondance égale, un produit disponible précède un produit épuisé. C'est le deuxième paramètre par importance, car un résultat non achetable n'est utile ni à l'acheteur ni au vendeur. Les produits épuisés restent néanmoins visibles et ne sont pas retirés des résultats",
        "**Ventes réalisées** — à correspondance égale, un produit déjà acheté par d'autres professionnels précède un produit sans historique de ventes. L'effet est progressif mais décroissant : l'écart entre aucune vente et les premières ventes compte bien plus que celui entre beaucoup et énormément, de sorte qu'un produit établi n'occupe pas la position de façon permanente",
        "**Avis reçus** — moyenne des notes, pondérée par leur nombre : quelques excellents avis pèsent moins que de nombreux bons avis. Les avis ne sont admis que de la part d'acheteurs ayant effectivement acheté ce produit sur la plateforme",
        "**Produits récemment publiés** — les produits publiés récemment bénéficient d'un avantage explicite de classement, qui diminue progressivement au cours des trois premiers mois. C'est un choix délibéré : sans lui, une place de marché favoriserait durablement ceux qui vendent déjà, et un vendeur qui arrive aujourd'hui n'aurait aucun moyen de démarrer",
        "**Placement payant** — les vendeurs peuvent acheter des offres de visibilité (produits mis en avant, emplacements en page d'accueil, emplacements par catégorie, cartes contextuelles). Ces contenus sont **toujours signalés comme « Sponsorisé »**. Dans les résultats de recherche, le parrainage **s'ajoute** au score du produit et ne le multiplie pas : il peut donc l'emporter à correspondance égale, mais **ne peut pas placer un produit peu pertinent au-dessus d'un produit très pertinent**. Lorsqu'un emplacement payant est disponible mais qu'aucun vendeur ne l'a acheté, nous affichons un produit non sponsorisé avec la mention neutre « En vedette », sans lui attribuer un parrainage inexistant",
        "**Historique d'achat et de navigation de l'acheteur** — utilisé pour suggérer des produits pertinents, avec des données collectées uniquement sur cette plateforme. Il n'affecte ni les prix ni les conditions et ne prévaut jamais sur les choix explicites de l'acheteur ni sur les emplacements payants",
        "**Aucune préférence de vendeur** — l'ancienneté, le volume global de ventes du vendeur, la formule souscrite et l'achat éventuel d'autres services n'influencent en rien le classement de ses produits. Oralzon ne vend pas de produits propres et n'a donc aucune position à favoriser"
      ],
    },
    {
