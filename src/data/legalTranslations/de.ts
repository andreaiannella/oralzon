  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Die Suchergebnisse werden geordnet, indem die **Übereinstimmung mit dem Suchbegriff** mit einigen produktbezogenen Parametern verbunden wird. Die Übereinstimmung bleibt der dominierende Faktor: die übrigen Parameter bestimmen die Reihenfolge **zwischen gleich relevanten Produkten** und nicht, ein weniger relevantes Produkt vor ein relevanteres zu setzen."
      ],
      bullets: [
        "**Übereinstimmung mit der Suche** — der maßgebliche Parameter, den kein anderer aufheben kann. Die Suche vergleicht den eingegebenen Begriff mit Produktname (auch übersetzt), Marke, Artikelnummer und Beschreibung, mit in dieser Reihenfolge abnehmendem Gewicht: eine Übereinstimmung im Namen zählt mehr als dasselbe Wort nur in der Beschreibung",
        "**Vom Käufer gewählte Filter und Sortierung** — sortiert der Käufer nach Preis, hat diese Wahl Vorrang vor allen anderen Parametern, einschließlich bezahlter Platzierungen",
        "**Verfügbarkeit** — bei gleicher Übereinstimmung steht ein verfügbares Produkt vor einem ausverkauften. Es ist der zweitwichtigste Parameter, denn ein nicht kaufbares Ergebnis nützt weder dem Käufer noch dem Verkäufer. Ausverkaufte Produkte bleiben dennoch sichtbar und werden nicht aus den Ergebnissen entfernt",
        "**Erzielte Verkäufe** — bei gleicher Übereinstimmung steht ein von anderen Fachleuten bereits gekauftes Produkt vor einem ohne Verkaufshistorie. Die Wirkung ist fortschreitend, aber abnehmend: der Unterschied zwischen keinem und den ersten Verkäufen zählt weit mehr als der zwischen vielen und sehr vielen, sodass ein etabliertes Produkt die Position nicht dauerhaft besetzt",
        "**Erhaltene Bewertungen** — Durchschnitt der Bewertungen, gewichtet nach deren Anzahl: wenige sehr gute Bewertungen zählen weniger als viele gute. Bewertungen sind ausschließlich von Käufern zugelassen, die dieses Produkt tatsächlich auf der Plattform gekauft haben",
        "**Kürzlich veröffentlichte Produkte** — kürzlich veröffentlichte Produkte erhalten einen ausdrücklichen Ranking-Vorteil, der in den ersten drei Monaten allmählich abnimmt. Dies ist eine bewusste Entscheidung: ohne sie würde ein Marktplatz dauerhaft diejenigen begünstigen, die bereits verkaufen, und ein heute einsteigender Verkäufer hätte keine Möglichkeit anzufangen",
        "**Bezahlte Platzierung** — Verkäufer können Sichtbarkeitspakete erwerben (hervorgehobene Produkte, Startseitenplätze, Kategorieplätze, kontextbezogene Karten). Solche Inhalte sind **stets als „Gesponsert“ gekennzeichnet**. In den Suchergebnissen wird das Sponsoring zur Produktbewertung **addiert** und nicht multipliziert: es kann daher bei gleicher Übereinstimmung den Vorrang geben, **aber kein schlecht passendes Produkt über ein gut passendes stellen**. Ist ein bezahlter Platz verfügbar, aber von keinem Verkäufer erworben, zeigen wir ein nicht gesponsertes Produkt mit der neutralen Kennzeichnung „Hervorgehoben“, ohne ihm ein nicht bestehendes Sponsoring zuzuschreiben",
        "**Kauf- und Browsing-Historie des Käufers** — verwendet, um passende Produkte vorzuschlagen, mit ausschließlich auf dieser Plattform erhobenen Daten. Sie beeinflusst weder Preise noch Bedingungen und hat nie Vorrang vor den ausdrücklichen Entscheidungen des Käufers oder vor bezahlten Plätzen",
        "**Keine Verkäuferbevorzugung** — Dienstalter, Gesamtumsatz des Verkäufers, gewählter Tarif und der Erwerb weiterer Dienste haben keinerlei Einfluss auf das Ranking seiner Produkte. Oralzon verkauft keine eigenen Produkte und hat daher keine Positionen zu begünstigen"
      ],
    },
    {
