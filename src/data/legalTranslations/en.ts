  ...
  termini: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "**Match with the search query** — the prevailing parameter: text search compares the term entered against the product name, brand and item code",
          "**Filters and sorting chosen by the buyer** — when the buyer sorts by price or by date, that choice prevails over every other parameter, including paid placements",
          "**Availability and product status** — unpublished products, and products of suspended vendors, do not appear",
          "**Paid placement** — vendors may purchase visibility packages (featured products, homepage slots, category slots, contextual cards). Such content is **always labelled “Sponsored”** and its position depends solely on the purchase of the package, not on any assessment of product quality. Where a paid slot is available but no vendor has purchased it, we display a non-sponsored product with the neutral label “Featured”, without attributing to it a sponsorship that does not exist",
          "**The buyer’s purchase and browsing history** — used to suggest relevant products, based solely on data collected on this platform. It does not affect prices or terms and never prevails over the buyer’s explicit choices or over paid placements",
          "**Sales achieved and reviews received** — in the sections dedicated to best-selling products"
        ],
      },
      {
