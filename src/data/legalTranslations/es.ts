 ...
 *
 * 1. Los marcadores [DENOMINAZIONE SOCIALE DA COMPLETARE],
 *    [INDIRIZZO SEDE LEGALE] y [PARTITA IVA] se mantienen en su forma
 *    italiana, idénticos en todas las versiones lingüísticas. Así, para
 *    completarlos bastará una única búsqueda-y-reemplazo sobre los ocho
 *    ficheros, en lugar de ocho modificaciones separadas con el riesgo de
 *    olvidar alguna.
 *
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "El operador de la plataforma es **[DENOMINAZIONE SOCIALE DA COMPLETARE]**, con domicilio en **[INDIRIZZO SEDE LEGALE]**, NIF-IVA **[PARTITA IVA]**, contactable en support@oralzon.com.",
    ...
    },
    {
      ...
      bullets: [
        "**Coincidencia con la búsqueda** — es el parámetro predominante: la búsqueda textual compara el término introducido con el nombre, la marca y la referencia del producto",
        "**Filtros y orden elegidos por el comprador** — cuando el comprador ordena por precio o por fecha, esa elección prevalece sobre cualquier otro parámetro, incluidas las posiciones de pago",
        "**Disponibilidad y estado del producto** — los productos no publicados o de vendedores suspendidos no aparecen",
        "**Posicionamiento de pago** — los vendedores pueden adquirir paquetes de visibilidad (productos destacados, espacios en la portada, espacios por categoría, tarjetas contextuales). Estos contenidos van **siempre identificados como «Patrocinado»** y su posición depende exclusivamente de la compra del paquete, no de un juicio de calidad sobre el producto. Cuando un espacio de pago está disponible pero ningún vendedor lo ha adquirido, mostramos un producto no patrocinado con la etiqueta neutra «Destacado», sin atribuirle un patrocinio inexistente",
        "**Historial de compra y de navegación del comprador** — utilizado para sugerir productos pertinentes, con datos recogidos únicamente en esta plataforma. No incide en precios ni condiciones y nunca prevalece sobre las elecciones explícitas del comprador ni sobre los espacios de pago",
        "**Ventas realizadas y reseñas recibidas** — en las secciones dedicadas a los productos más vendidos"
      ],
    },
    {
