  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "De zoekresultaten worden geordend door de **overeenkomst met de zoekterm** te combineren met enkele productgebonden parameters. De overeenkomst blijft de dominante factor: de overige parameters bepalen de volgorde **tussen even relevante producten**, en niet om een minder relevant product boven een relevanter te plaatsen."
      ],
      bullets: [
        "**Overeenkomst met de zoekopdracht** — de bepalende parameter, die geen andere kan omzeilen. De zoekopdracht vergelijkt de ingevoerde term met de productnaam (ook vertaald), het merk, het artikelnummer en de beschrijving, met in die volgorde afnemend gewicht: een overeenkomst in de naam weegt zwaarder dan hetzelfde woord dat alleen in de beschrijving voorkomt",
        "**Door de koper gekozen filters en sortering** — sorteert de koper op prijs, dan gaat die keuze voor op elke andere parameter, ook op betaalde plaatsingen",
        "**Beschikbaarheid** — bij gelijke overeenkomst gaat een beschikbaar product vóór een uitverkocht product. Het is de tweede parameter in belang, omdat een resultaat dat niet gekocht kan worden noch de koper noch de verkoper helpt. Uitverkochte producten blijven wel zichtbaar en worden niet uit de resultaten verwijderd",
        "**Gerealiseerde verkopen** — bij gelijke overeenkomst gaat een product dat al door andere professionals is gekocht vóór een product zonder verkoophistorie. Het effect is toenemend maar afvlakkend: het verschil tussen geen en de eerste verkopen weegt veel zwaarder dan dat tussen veel en zeer veel, zodat een gevestigd product de positie niet blijvend bezet",
        "**Ontvangen beoordelingen** — gemiddelde van de beoordelingen, gewogen naar hun aantal: enkele uitstekende beoordelingen wegen minder dan veel goede. Beoordelingen zijn uitsluitend toegestaan van kopers die dat product daadwerkelijk op het platform hebben gekocht",
        "**Recent gepubliceerde producten** — recent gepubliceerde producten krijgen een uitdrukkelijk voordeel in de rangschikking, dat in de eerste drie maanden geleidelijk afneemt. Dit is een bewuste keuze: zonder dat zou een marktplaats blijvend degenen bevoordelen die al verkopen, en zou een verkoper die vandaag begint geen kans hebben om te starten",
        "**Betaalde plaatsing** — verkopers kunnen zichtbaarheidspakketten aanschaffen (uitgelichte producten, plaatsen op de homepage, plaatsen per categorie, contextuele kaarten). Deze inhoud is **altijd aangeduid als „Gesponsord”**. In de zoekresultaten wordt de sponsoring bij de score van het product **opgeteld** en niet vermenigvuldigd: zij kan dus de voorkeur geven bij gelijke overeenkomst, maar **kan geen slecht passend product boven een goed passend product plaatsen**. Is een betaalde plaats beschikbaar maar door geen verkoper aangeschaft, dan tonen wij een niet-gesponsord product met de neutrale aanduiding „Uitgelicht”, zonder daaraan een niet-bestaande sponsoring toe te schrijven",
        "**Aankoop- en browsegeschiedenis van de koper** — gebruikt om relevante producten voor te stellen, met gegevens die uitsluitend op dit platform zijn verzameld. Zij beïnvloedt prijzen noch voorwaarden en gaat nooit voor op de uitdrukkelijke keuzes van de koper of op betaalde plaatsen",
        "**Geen voorkeur voor verkopers** — anciënniteit, het totale verkoopvolume van de verkoper, het gekozen plan en de eventuele aanschaf van andere diensten hebben geen enkele invloed op de rangschikking van zijn producten. Oralzon verkoopt geen eigen producten en heeft dus geen posities te bevoordelen"
      ],
    },
    {
