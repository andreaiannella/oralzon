...
export const TERMINI_SERVIZIO_IT: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "**Corrispondenza con la ricerca** — è il parametro prevalente: la ricerca testuale confronta il termine inserito con nome, marca e codice articolo del prodotto",
        "**Filtri e ordinamento scelti dall'acquirente** — quando l'acquirente ordina per prezzo o per data, quella scelta prevale su ogni altro parametro, comprese le posizioni a pagamento",
        "**Disponibilità e stato del prodotto** — i prodotti non pubblicati o di venditori sospesi non compaiono",
        "**Posizionamento a pagamento** — i venditori possono acquistare pacchetti di visibilità (prodotti in evidenza, spazi in homepage, spazi per categoria, card contestuali). Questi contenuti sono **sempre contrassegnati come “Sponsorizzato”** e la loro posizione dipende esclusivamente dall'acquisto del pacchetto, non da un giudizio di qualità sul prodotto. Quando uno spazio a pagamento è disponibile ma nessun venditore lo ha acquistato, mostriamo un prodotto non sponsorizzato con l'etichetta neutra “In evidenza”, senza attribuirgli una sponsorizzazione inesistente",
        ...
        "**Vendite realizzate e recensioni ricevute** — nelle sezioni dedicate ai prodotti più venduti"
      ],
    },
    {
